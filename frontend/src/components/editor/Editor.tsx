    ...
    >
      ...
      <Box sx={{ p: 2, minHeight: 400 }}>
        {tabIndex === 0 ? (
          ...
          /* THIS IS THE PREVIEW - It will be perfectly themed */
          <Box
            sx={{
              color: "text.primary",
              bgcolor: "background.default", // Matches your theme background
              p: 3,
              borderRadius: 1,
              "& .katex": { color: "inherit" }, // Forces math to match text color
